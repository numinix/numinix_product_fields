    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-md-6">
              ...
              <span class="input-group-addon"><?php echo zen_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']); ?>&nbsp;</span>
                    <?php echo zen_draw_textarea_field('care_instructions[' . $languages[$i]['id'] . ']', 'soft', '100', '30', htmlspecialchars((isset($care_instructions[$languages[$i]['id']])) ? stripslashes($care_instructions[$languages[$i]['id']]) : ((zen_get_care_instructions($pInfo->products_id, $languages[$i]['id']) != null) ? zen_get_care_instructions($pInfo->products_id, $languages[$i]['id']) : '') , ENT_COMPAT, CHARSET, TRUE), 'class="editorHook form-control"'); ?>
