...
?>
     <div class="form-group">
          <p class="col-sm-3 control-label"><?php if ($i == 0) echo TEXT_PRODUCTS_DESCRIPTION2; ?></p>
...
//                $oFCKeditor->Create() ;
            ...
            echo zen_draw_textarea_field('products_description2[' . $languages[$i]['id'] . ']', 'soft', '100%', '30', (isset($products_description2[$languages[$i]['id']])) ? stripslashes($products_description2[$languages[$i]['id']]) : zen_get_products_description2($pInfo->products_id, $languages[$i]['id']),'class="form-control"'); //,'id="'.'products_description' . $languages[$i]['id'] . '"');
          } ?>
             <br>
                </div>
        </div>
...
//                $oFCKeditor->Create() ;
            ...
            echo zen_draw_textarea_field('products_description2[' . $languages[$i]['id'] . ']', 'soft', '100', '30', (isset($products_description2[$languages[$i]['id']])) ? stripslashes($products_description2[$languages[$i]['id']]) : zen_get_products_description2($pInfo->products_id, $languages[$i]['id'], ENT_COMPAT, CHARSET, TRUE), 'class="editorHook form-control"'); //,'id="'.'products_description' . $languages[$i]['id'] . '"');
          } ?>
                  </td>
                </tr>
              </table>
