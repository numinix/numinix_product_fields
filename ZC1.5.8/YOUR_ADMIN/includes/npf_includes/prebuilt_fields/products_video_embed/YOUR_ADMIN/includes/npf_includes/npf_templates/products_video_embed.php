...
if($zc156){ ?>
     <div class="form-group">
        ...
        <div class="col-sm-9 col-md-6">
                        <?php echo zen_draw_textarea_field('products_video_embed', 'soft', '100%', '30', $pInfo->products_video_embed,'class="form-control"'); ?>                  </td>
        </div>
    </div>
    ...
    <div class="form-group">
          <p class="col-sm-3 control-label"><?php echo TEXT_PRODUCTS_VIDEO_EMBED; ?></p>
        <div class="col-sm-9 col-md-6">
                  <?php echo zen_draw_input_field('products_video_embed_thumbnail', $pInfo->products_video_embed_thumbnail, 'class="form-control"'); ?>
        </div>
    </div>
<?php } else { ?>
          <tr>
