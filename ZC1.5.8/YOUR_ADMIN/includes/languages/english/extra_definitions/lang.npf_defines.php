...
*/
  ...
  $define = [
    'TEXT_NUMINIX_PRODUCT_FIELDS' => 'Numinix Product Fields',
    'NPF_DEFINITIONS_FOLDER' =>  DIR_WS_LANGUAGES . $_SESSION['language'] . '/npf_definitions/',
    'NPF_INCLUDES_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/', 
    'NPF_INCLUDES_SQL_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/' . 'npf_sql/',
    'NPF_INCLUDES_MODULES_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/' . 'npf_modules/',
    'NPF_INCLUDES_TEMPLATES_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/' . 'npf_templates/',
    'NPF_INCLUDES_PROCESSING_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/' . 'npf_process/',
    'NPF_INCLUDES_SQL_ARRAY_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/' . 'npf_sql_array/',
    'NPF_INCLUDES_CUSTOM_EXECUTE_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/' . 'npf_custom_execute/', 
    'NPF_INCLUDES_DESCRIPTION_SQL_ARRAY_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/' . 'npf_description_sql_array/',  
    'NPF_INCLUDES_PREVIEW_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/' . 'npf_preview/',   
    'NPF_INCLUDES_PREVIEW_INFO_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/' . 'npf_preview_info/', 
    'NPF_INCLUDES_PREBUILT_FOLDER' =>  DIR_WS_INCLUDES . 'npf_includes/' . 'prebuilt_fields/'
  ];
  
    $dirList = dirList($define['NPF_DEFINITIONS_FOLDER']);
    $npf_definitions_folder = $define['NPF_DEFINITIONS_FOLDER'];
  foreach ($dirList as $file) {
    include($npf_definitions_folder . $file);  
  }
