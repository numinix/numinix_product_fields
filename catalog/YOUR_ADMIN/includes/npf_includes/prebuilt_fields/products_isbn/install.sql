ALTER TABLE products ADD products_upc varchar(32) DEFAULT NULL after products_model;
ALTER TABLE products ADD products_isbn varchar(32) DEFAULT NULL after products_upc;
ALTER TABLE products ADD products_ean varchar(32) DEFAULT NULL after products_isbn;
ALTER TABLE products ADD products_asin varchar(32) DEFAULT NULL after products_ean;
