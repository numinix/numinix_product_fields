<div class="form-group">
	...
	<div class="col-sm-9 col-md-6">
		...
		<div class="input-group">
			...
			<?php
			$products_description2_ = isset($products_description2[$languages[$i]['id']]) ? stripslashes($products_description2[$languages[$i]['id']]) : zen_get_products_description2($pInfo->products_id, $languages[$i]['id']);
