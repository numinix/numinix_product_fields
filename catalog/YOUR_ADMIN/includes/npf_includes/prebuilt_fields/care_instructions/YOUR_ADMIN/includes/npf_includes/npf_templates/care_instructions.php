<div class="form-group">
	...
	<div class="col-sm-9 col-md-6">
		...
		<div class="input-group">
			...
			<?php
			$care_instructions_ = isset($care_instructions[$languages[$i]['id']]) ? stripslashes($care_instructions[$languages[$i]['id']]) : zen_get_care_instructions($pInfo->products_id, $languages[$i]['id']);
