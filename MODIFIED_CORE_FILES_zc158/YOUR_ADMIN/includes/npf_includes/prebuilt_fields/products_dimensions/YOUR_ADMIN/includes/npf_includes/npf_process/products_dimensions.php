<?php
  ...
  $products_weight_type = (!zen_not_null($tmp_value) || $tmp_value=='') ? TEXT_PRODUCT_WEIGHT_UNIT : $tmp_value;
  $tmp_value = zen_db_prepare_input($_POST['products_dim_type']);
  $products_dim_type = (!zen_not_null($tmp_value) || $tmp_value=='') ? ((defined('SYSTEM_DIMENSION_UNITS')) ? SYSTEM_DIMENSION_UNITS : '') : $tmp_value;
