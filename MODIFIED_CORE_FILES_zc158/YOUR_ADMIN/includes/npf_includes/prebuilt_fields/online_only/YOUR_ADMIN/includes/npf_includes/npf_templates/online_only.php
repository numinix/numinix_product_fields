...
if($zc156){ ?>
          <div class="form-group">
            ...
            <div class="col-sm-9 col-md-6">
                <?php echo zen_draw_checkbox_field('online_only', 1, ($pInfo->online_only) ? true : false); ?>
            </div>
          </div>
<?php } else { ?>
          <tr>
          ...
          <tr bgcolor="#DDEACC">
            <td class="main"><?php echo TEXT_PRODUCTS_ONLINE_ONLY; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_checkbox_field('online_only', 1, ($pInfo->online_only) ? true : false); ?></td>
          </tr>
          <tr>
            <td colspan="2"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
