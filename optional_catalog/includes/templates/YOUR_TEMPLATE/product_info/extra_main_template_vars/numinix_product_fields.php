...
$npf_attributes = "";
if (defined('SHOW_PRODUCT_INFO_DIAMETER') && SHOW_PRODUCT_INFO_DIAMETER == 1) {
    $npf_attributes .= ', p.products_diameter';
    $flag_show_product_info_diameter = 1;
}
if (defined('SHOW_PRODUCT_INFO_DIMENSIONS') && SHOW_PRODUCT_INFO_DIMENSIONS == 1) {
    $npf_attributes .= ', p.products_length, p.products_width, p.products_height, p.products_dim_type';
    $flag_show_product_info_dimensions = 1;
}
if (defined('SHOW_PRODUCT_INFO_ACTUAL_WEIGHT') && SHOW_PRODUCT_INFO_ACTUAL_WEIGHT == 1) {
    $npf_attributes .= ', p.products_actual_weight, p.products_weight_type';
    $flag_show_product_info_actual_weight = 1;
}
if (defined('SHOW_PRODUCT_INFO_CONDITION') && SHOW_PRODUCT_INFO_CONDITION == 1) {
    $npf_attributes .= ', p.products_condition';
    $flag_show_product_info_condition = 1;
}
if ((defined('SHOW_PRODUCT_INFO_UPC') && SHOW_PRODUCT_INFO_UPC == 1) || (defined('SHOW_PRODUCT_INFO_ISBN') && SHOW_PRODUCT_INFO_ISBN == 1)) {
    $npf_attributes .= ', p.products_upc, p.products_isbn';
    $flag_show_product_info_upc = 1;
    $flag_show_product_info_isbn = 1;
}
if (defined('SHOW_PRODUCT_INFO_OUT_OF_STOCK') && SHOW_PRODUCT_INFO_OUT_OF_STOCK == 1) {
    $npf_attributes .= ', p.out_of_stock';
    $flag_show_product_info_out_of_stock = 1;
}
if (defined('SHOW_PRODUCT_INFO_SKU') && SHOW_PRODUCT_INFO_SKU == 1) {
    $npf_attributes .= ', p.products_sku';
    $flag_show_product_info_sku = 1;
}
if (defined('SHOW_PRODUCT_INFO_CARE_INSTRUCTIONS') && SHOW_PRODUCT_INFO_CARE_INSTRUCTIONS == 1) {
    $npf_attributes .= ', pd.care_instructions';
}
if (defined('SHOW_PRODUCT_INFO_DESCRIPTION2') && SHOW_PRODUCT_INFO_DESCRIPTION2 == 1) {
    $npf_attributes .= ', pd.products_description2';
}
