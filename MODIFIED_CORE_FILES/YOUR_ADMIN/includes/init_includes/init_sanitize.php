...
// bof modified by numinix for extra sanitation rules
if ( file_exists(DIR_WS_INCLUDES . 'init_includes/extra_sanitation_rules.php') ) {
    include(DIR_WS_INCLUDES . 'init_includes/extra_sanitation_rules.php');
}
// eof modified by numinix for extra sanitation rules
